...
The [demo notebook](tutorials/demo.ipynb) shows how to generate new cells in test sections using TissueNarrator. It typically runs in about 10 minutes, depending on your GPU setup.
